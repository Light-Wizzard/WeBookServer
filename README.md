...
but I do not have the upload/download manager completed yet.
...
* [Installer](#Installer)
* [Version](#Version)
    * [Version Decoded](#Version-Decoded)
...
Currently the WeBookServer will compile and run on Windows 10 Pro and Linux.
...
which eventually I figured out that unless you change the script to run python3 instead of just python, 
which defaults to 2.x, in Linux I do not have this issue, since it soft links python3 to python,
so the Linux error confused me, also officially it currently qdep only supports Python 3.7x, 
and no matter how hard I tried in Windows 10 Pro, it would not allow me to run Python 3,
instead it runs its own version of Python, which is 3.83, and 3.9 is out, 
so down the Rabbit how I go.

I started from scratch using the Echo Service Example again,
but this time, instead of using the Online Installer,
I downloaded the [Offline](http://download.qt.io/official_releases/qt/) 5.14.1, so I could match the installation packages for the Forked version of [QtService](https://github.com/Skycoder42/QtService),
and just as in the Linux Online Installation problems, installing the Arch Linux Manjaro pacman install fix that issue,
that offline Qt installer seemed to solve the issues I was have,
now the Python script runs,
and I can compile the project with no more errors.

## Linux

I wrote and tested this app on Arch Linux Manjaro, as well as Ubuntu LTS.

## Mac

I do not own a Mac, till I do, I cannot test anything on it.

## Windows

I tested this on Windows 10 Pro.

## Downloads

Check [Status](#Status) if Link does not work, if pending, just wait for it, it rarely takes more then 9 minutes start to stop.
...
Mac
- :apple: [Apple](https://github.com/Light-Wizzard/WeBookServer/releases/download/continuous/WeBookServer.dmg) 
 
Windows see [Windows](#Windows)
- :office: [Windows zip exe](https://github.com/Light-Wizzard/WeBookServer/releases/download/continuous/WeBookServer-release.zip)
- :office: :outbox_tray: [Windows Installer exe](https://github.com/Light-Wizzard/WeBookServer/releases/download/continuous/WeBookServer-Installer.exe)
- :office: :outbox_tray: [Windows Installer zip](https://github.com/Light-Wizzard/WeBookServer/releases/download/continuous/WeBookServer-Installer.zip)
...
I am using QtHttpServer by QtLabs , and a Fork of QtService by QtProject for those jobs.
...
* QtService: https://github.com/qtproject/qt-solutions/tree/master/qtservice
    * Fork: https://github.com/Skycoder42/QtService

To install QtHttpServer, you need to create a root folder for the Project to sit in:

* root\WeBookServer
* root\WeBookClient

Change to the root folder, and do a git clone including --recurse-submodules

```
# This is a one time initialization
# GitHub Clone and include submodules
# Offical QtHttpServer
...
I decided to link it, rather then joining it as a subdir project for one reason,
...
and I will keep it this way, all code is compiled in using my Fork,
and I will update it after testing it.
...
Version applies to each Module I use, 
and what Compiler, as well as what OS or Distribution it was compiled for,
as such, I must define what I am talking about,
when it comes to versions.

Both the Client and Server are written in Qt C++.
I will try to make a QML Client that mimics the C++ UI geared for Mobile: Android, iOS...

Qt: Minimum Version is 5.14.0 due to a feature I use in the Text Editor.

QtHttpServer requires Qt 5.12.0.

The Compiler in the CONFIG needs to be c++11 minimum, c++14 might be the Minimum, need to test that but c++17 is better, or 20a.

So far I know the Client works on Windows 7 with C++11, I will post any new updates when I get them.
...
but what can I say but George loves to Golf,
...
This was written on Arch Linux or Manjaro with pacman install.
...
Ubuntu LTS Qt online installer

```
QT_SYSROOT:
QT_INSTALL_PREFIX:/home/jflesher/Qt/5.14.2/gcc_64
QT_INSTALL_ARCHDATA:/home/jflesher/Qt/5.14.2/gcc_64
QT_INSTALL_DATA:/home/jflesher/Qt/5.14.2/gcc_64
QT_INSTALL_DOCS:/home/jflesher/Qt/Docs/Qt-5.14.2
QT_INSTALL_HEADERS:/home/jflesher/Qt/5.14.2/gcc_64/include
QT_INSTALL_LIBS:/home/jflesher/Qt/5.14.2/gcc_64/lib
QT_INSTALL_LIBEXECS:/home/jflesher/Qt/5.14.2/gcc_64/libexec
QT_INSTALL_BINS:/home/jflesher/Qt/5.14.2/gcc_64/bin
QT_INSTALL_TESTS:/home/jflesher/Qt/5.14.2/gcc_64/tests
QT_INSTALL_PLUGINS:/home/jflesher/Qt/5.14.2/gcc_64/plugins
QT_INSTALL_IMPORTS:/home/jflesher/Qt/5.14.2/gcc_64/imports
QT_INSTALL_QML:/home/jflesher/Qt/5.14.2/gcc_64/qml
QT_INSTALL_TRANSLATIONS:/home/jflesher/Qt/5.14.2/gcc_64/translations
QT_INSTALL_CONFIGURATION:/home/jflesher/Qt/5.14.2/gcc_64
QT_INSTALL_EXAMPLES:/home/jflesher/Qt/Examples/Qt-5.14.2
QT_INSTALL_DEMOS:/home/jflesher/Qt/Examples/Qt-5.14.2
QT_HOST_PREFIX:/home/jflesher/Qt/5.14.2/gcc_64
QT_HOST_DATA:/home/jflesher/Qt/5.14.2/gcc_64
QT_HOST_BINS:/home/jflesher/Qt/5.14.2/gcc_64/bin
QT_HOST_LIBS:/home/jflesher/Qt/5.14.2/gcc_64/lib
QMAKE_SPEC:linux-g++
QMAKE_XSPEC:linux-g++
QMAKE_VERSION:3.1
QT_VERSION:5.14.2
...
# add to git, this did not add all the submodules
git submodule add https://github.com/qt-labs/qthttpserver.git qthttpserver --recursive --recurse-submodules
...
You can stop reading now, seriously, stop, over and out, the end, no wait, thought I had something more to say, like if you need more information see the [Table of contents](#Table-Of-Contents).
